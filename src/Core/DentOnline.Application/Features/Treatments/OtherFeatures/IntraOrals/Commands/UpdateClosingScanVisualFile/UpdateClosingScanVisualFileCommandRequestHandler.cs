...
public class
    UpdateClosingScanVisualFileCommandRequestHandler : IRequestHandler<UpdateClosingScanVisualFileCommandRequest,
        IResponse>
{
    ...
    public UpdateClosingScanVisualFileCommandRequestHandler(ITreatmentReadRepository treatmentRepository,
    ...
    public async Task<IResponse> Handle(UpdateClosingScanVisualFileCommandRequest request,
        CancellationToken cancellationToken)
    {
        ...
        treatment.IntraOral.ClosingScanVisualFile = createdFileResult.Data.First();
        ...
        return new SuccessResponse(_languageService.Get(Messages.ClosingScanVisualFileIsUpdated));
    }
}