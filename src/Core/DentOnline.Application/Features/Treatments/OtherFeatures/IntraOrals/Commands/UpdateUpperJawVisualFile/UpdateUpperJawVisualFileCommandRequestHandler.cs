...
public class
    UpdateUpperJawVisualFileCommandRequestHandler : IRequestHandler<UpdateUpperJawVisualFileCommandRequest, IResponse>
{
    ...
    public UpdateUpperJawVisualFileCommandRequestHandler(ITreatmentReadRepository treatmentRepository,
    ...
    public async Task<IResponse> Handle(UpdateUpperJawVisualFileCommandRequest request,
        CancellationToken cancellationToken)
    {
        ...
        treatment.IntraOral.UpperJawVisualFile = createdFileResult.Data.First();
        ...
        return new SuccessResponse(_languageService.Get(Messages.UpperJawVisualFileIsUpdated));
    }
}